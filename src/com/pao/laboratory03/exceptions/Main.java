...
public class Main {
    ...
    public static void riskyMethod() {
        String s = null;
        s.length(); // Aici va "crăpa" programul
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            list.add("Ana");
            addToList(list, "Ana"); // Aici va da eroare pentru că "Ana" există deja
        ...
        try {
            ...
            System.out.println("Excepție generală prinsă: " + e.getMessage());
        }
